...
//adding date in format dd/mm/yyyy,hour:min
const noww=new Date()
...
const textContent=`${date}/${month}/${year},${hour}:${min}`
console.log(textContent)  // 5/10/2023,13:13  //here is 5 we want 05 so do this;(padstart)
const datePad=`${noww.getDate()}`.padStart(2,0) //2 is length 
const monthPad=`${noww.getMonth()}`.padStart(2,0)
const textContentCorrect=`${datePad}/${monthPad}/${year},${hour}:${min}`
console.log(textContentCorrect) //05/10/2023,13:13
